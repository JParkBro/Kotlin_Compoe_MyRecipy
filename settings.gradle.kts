...
include(":feature:shell:category:manage:api")
include(":feature:shell:category:manage:impl")
include(":feature:shell:category:editor:api")
include(":feature:shell:category:editor:impl")
